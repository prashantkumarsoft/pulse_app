...
RSpec.describe "Members", type: :request do
  describe 'POST #create' do
    context 'with valid params' do
      ...
      it 'creates a new member' do
        ...
        expect(JSON.parse(response.body)["message"]).to eq("Member added successfully")
      end
    end
  ...
  describe 'GET #doctors' do
    ...
    it 'returns a list of doctors' do
      get '/members/doctors'
      expect(response).to have_http_status(:success)
      expect(JSON.parse(response.body)).to include(JSON.parse(DoctorSerializer.new(doctor).to_json))
    end
  end
  ...
  describe 'GET #patients' do
    ...
    it 'returns a list of patients' do
      ...
      expect(response).to have_http_status(:success)
      expect(JSON.parse(response.body)).to include(JSON.parse(PatientSerializer.new(patient).to_json))
    end
  end
end
